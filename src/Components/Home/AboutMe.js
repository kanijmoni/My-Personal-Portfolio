    ...
    return (
        <div id='aboutMe' className='mx-12 mt-20'>
            ...
            <div className="flex flex-col w-full lg:flex-row">
                <div className="grid flex-grow h-72 w-1/2 card bg-base-300 rounded-box place-items-center"> <h2 className='text-xl text-center font-bold'>My Skills</h2>
                ...
                <div className="grid flex-grow h-72 w-1/2 card bg-base-300 rounded-box place-items-center">
